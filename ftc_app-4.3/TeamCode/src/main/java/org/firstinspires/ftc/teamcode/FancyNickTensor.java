...
//@Disabled
@Autonomous(name="FancyTensor", group="Tensor")
public class FancyNickTensor extends LinearOpMode
{
    ...
    private int numberOfRecognitions;
    ...
    public boolean returnIfGold()
    {
        return isGold;
    }
    public boolean returnIfSilver()
    {
        return isSilver;
    }
